                      ...
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 30, top: 40,right: 30),
                            child: Image.asset('images/img_login.png',fit: BoxFit.cover,)), // Logo at the top
                        // SizedBox(height: 20),
                        Text(
                          'WELCOME',
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsets.only(left: 6.0), // Add padding to the left
                              child: SizedBox(
                                height: 30,
                                child: Container(
                                    ...
                                    items: options.map((String dropDownStringItem) {
                                      return DropdownMenuItem<String>(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Icon(
                                              Icons.arrow_drop_down, // You can change this to any icon
                                              color: Colors.black,
                                            ),
                                            Text(
                                              dropDownStringItem,
                          ...
                          children: [
                            ...
                            MaterialButton(
                              ...
                              onPressed: () {
                                ...
                                userService.signUp(_formkey,username.text,emailController.text,passwordController.text, rool, context);
                              },
                              child: Text(
                                "Register",
                                style: TextStyle(
