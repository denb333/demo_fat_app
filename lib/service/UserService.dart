...
class UserService {
  ...
  Future<void> signIn(GlobalKey<FormState> formKey, BuildContext context, String email, String password) async {
    if (formKey.currentState!.validate()) {
      try {
        ...
        await route(context); // Call route to navigate to HomePage if document exists
  ...
  Future<void> signUp(GlobalKey<FormState> formKey, String username, String email, String password,String rool, BuildContext context) async {
  ...
  Future<void> postDetailsToFirestore(String email, String username,String rool, BuildContext context) async {
